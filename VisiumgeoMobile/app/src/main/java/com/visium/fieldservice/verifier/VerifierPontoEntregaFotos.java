...
public class VerifierPontoEntregaFotos {
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if(input.getText().toString() == null || input.getText().toString().equals("")){
                    Toast.makeText(c, "Digite um numero", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    public static void promptAndAdd(final long geoCode, final PontoEntregaEditDialogFragment a)    {
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                    if(input.getText().toString() == null || input.getText().toString().equals("")){
                        Toast.makeText(a.getContext(), "Digite um numero", Toast.LENGTH_LONG).show();
                    }else {
    ...
    public static int getNextNumber(long geoCode, PontoEntregaEditDialogFragment a) {
        if(geoCode != rollBackGeoCode) {
            setRollBackStack(geoCode, lastNumber);
        }
