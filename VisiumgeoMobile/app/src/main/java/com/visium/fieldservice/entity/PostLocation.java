...
public class PostLocation implements Serializable {
    ...
    public PostLocation(PostLocationResponse resp){
    ...
    public PostLocation(Double lat, Double lon, Double latAtualizacao, Double lonAtualizacao) {
        this.lat = lat;
        this.lon = lon;
    ...
    public PostLocation(Double lat, Double lon) {
        this.lat = lat;
        this.lon = lon;
        //this.latAtualizacao = (double)0;
        //this.lonAtualizacao = (double)0;
