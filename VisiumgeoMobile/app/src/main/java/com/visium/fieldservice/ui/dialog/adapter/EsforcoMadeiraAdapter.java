...
public class EsforcoMadeiraAdapter extends BaseAdapter {

    private Context context;
    private List<PostEffortMadeira> postEffortMadeiras;

    public EsforcoMadeiraAdapter(Context context, List<PostEffortMadeira> postEffortMadeiras){
        this.context = context;
        this.postEffortMadeiras = postEffortMadeiras;
    }

    @Override
    public int getCount() {
        return postEffortMadeiras.size();
    }

    @Override
    public Object getItem(int i) {
        return postEffortMadeiras.get(i);
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        button.setText(postEffortMadeiras.get(i).getName()+"");
